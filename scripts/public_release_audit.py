...
def main() -> int:
    ...
    for path in root.rglob("*"):
        ...
        # A normal public Git checkout has a top-level .git directory; it is
        # repository metadata, not exported research content. Nested .git
        # directories are still blocked because they may smuggle private history.
        ...
        # Do not scan this scanner's own source for literal detector signatures;
        # otherwise its regex definitions necessarily trigger themselves.
        if rel != "scripts/public_release_audit.py":
