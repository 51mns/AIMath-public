...
REQUIRED = [
    ...
    "docs/RESEARCH_PORTFOLIO.md", "docs/RESEARCH_BOARD.md", "docs/DEPENDENCY_GRAPH.md", "docs/CAMPAIGN_HISTORY.md",
    ...
    "schemas/proposal.schema.json", "schemas/outcome.schema.json",
    "scripts/build_public_manifest.py", "scripts/reproduce_public_claims.py",
    "scripts/village_core.py", "scripts/village.py", "scripts/test_village_acceptance.py",
    "scripts/check_dco.py", "scripts/check_village_pr.py",
...
def main() -> int:
    ...
    if missing or campaign_count < 3 or task_count < 5 or claim_meta_count < 1:
