...
REQUIRED = [
    ...
    "scripts/lock_auto_activate.py", "scripts/workflow_security.py", "scripts/test_village_acceptance.py", "scripts/test_village_v1_1.py", "scripts/test_village_v1_2.py", "scripts/test_village_v1_2_1.py",
