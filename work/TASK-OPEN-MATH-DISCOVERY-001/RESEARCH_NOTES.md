...
```bash
python3 work/TASK-OPEN-MATH-DISCOVERY-001/open_math_discovery_coefficients.py \
  > /tmp/TASK-OPEN-MATH-DISCOVERY-001-results.json
sha256sum work/TASK-OPEN-MATH-DISCOVERY-001/open_math_discovery_coefficients.py \
  /tmp/TASK-OPEN-MATH-DISCOVERY-001-results.json
```
